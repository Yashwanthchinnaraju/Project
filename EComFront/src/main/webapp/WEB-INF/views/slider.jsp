<script src="resources/js/corousal.js"></script>
    ...
    <div id="jssor_1" style="position:relative;margin:0 auto;top:0px;left:0px;width:980px;height:380px;overflow:hidden;visibility:hidden;">
        ...
        <div data-u="slides" style="cursor:default;position:relative;top:0px;left:0px;width:980px;height:380px;overflow:hidden;">
            <div>
                <img data-u="image" src="resources/images/s1.jpg" />
            </div>
            <div>
                <img data-u="image" src="resources/images/s2.jpg" />
            </div>
           <div>
                <img data-u="image" src="resources/images/s3.jpg" />
            </div>
             <div>
                <img data-u="image" src="resources/images/s4.jpg" />
            </div>
            <div>
                <img data-u="image" src="resources/images/s5.jpg" />
            </div>
