		...
		<div class="col-md-6 col-md-offset-3">
			<div class="panel panel-primary">
				...
				<div class="panel-body">
					<form:form enctype="multipart/form-data" modelAttribute="prodmodel" action="productadd"
						method="post">
						<div class="form-group">
							<label for="fname">Product Name</label>
							<form:input type="text" id="fname" class="form-control"
								name="fname" placeholder="Example-John" path="procuctName" />
						</div>
						<div class="form-group">
					...
					<table id="myTable" class="table">
						...
						<tbody>
							<c:forEach items="${prodlist}" var="c">
								<tr>
									<td><img src="resources/pimage/${c.productId}.jpg" width="50" height="50"/></td>
									<td>${c.productId}</td>
									<td>${c.procuctName}</td>
									<td>${c.productDesc}</td>
									<td>${c.price}</td>
